                                    ...
                                    <button class="user__but" name="active" value=${friendId}>
                                        <div class="chats">
                                            <div class="start_chat">
                                                <div class="chat">
                                                    <div class="chat__img">
                                                        <img class="chat__pic" src="${pageContext.request.contextPath}/img/Dva.jpg" width="60" height="60" alt="user photo">
                                                    </div>
                                                </div>
                                                <div class="chat">
                                ...
                                <div class="messages element">
                                    <%
                                        ...
                                        for (Message message : list) {
                                            session.setAttribute("messageName", message.getSentUser().getName() + " " + message.getSentUser().getSurname());
