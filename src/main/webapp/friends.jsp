                        ...
                        <div class="search__results">
                            <div class="search__result">
                                <div class="time__place">
                                    <div class="post__time date">friends</div>
                                </div>
                                <form method="post" class="people element">
                                    <%
                                        FriendsPageService service = new FriendsPageService(new FriendDao());
                                        Integer tmpId;
                                        try {
                                        ...
                                        try {
                                            friends = service.getAllFriends(userId);
                                    ...
                                    <div class="user__info">
                                        ...
                                        <a class="start__info" href="/ozi?pageId=${toFollowId}">
                                            <div class="info-s__item">
                                                <div class="info__img">
                                                    <img class="info__pic" src="${pageContext.request.contextPath}/img/Dva.jpg" width="80" height="80" alt="user photo">
                                                </div>
                                            </div>
                                            <div class="info-s__item">
